...
export default function BlogSearch({ posts, query, categories }) {
                ...
                <section className="pt-32 pb-16 border-b border-white/[0.06]">
                    <div className="max-w-[1200px] mx-auto px-6">
                        <div className="text-center max-w-2xl mx-auto">
                            <h1 className="text-[32px] sm:text-[42px] font-semibold tracking-[-0.02em] leading-[1.1]">
                                Hasil pencarian
                            </h1>
                            <p className="mt-4 text-[16px] sm:text-[18px] text-white/50">
                                {items.length > 0 
                                    ? `Ditemukan ${posts?.total || items.length} artikel untuk "${query}"`
                    ...
                    <div className="max-w-[1200px] mx-auto px-6">
                        {items.length > 0 ? (
                            ...
                            <div className="text-center py-20">
                                ...
                                <h3 className="text-[18px] font-semibold text-white mb-2">Tidak ada hasil</h3>
                                <p className="text-[14px] text-white/50 mb-6">Coba kata kunci lain atau jelajahi kategori.</p>
                                <Link
                                    href={route('blog.index')}
