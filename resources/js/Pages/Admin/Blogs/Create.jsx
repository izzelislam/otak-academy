...
export default function BlogCreate({ categories, availableModels }) {
        ...
        <AdminLayout title="Create Blog Post">
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex items-center justify-between mb-6">
                    <BackLink href={route('admin.blogs.index')}>Kembali ke Blog Posts</BackLink>
                </div>
